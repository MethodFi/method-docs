...
only be used to receive payments. When creating a liability account, verification is done immediately
...
➡️ See [create a liability account](/guides/destination-accounts/liabilities).
