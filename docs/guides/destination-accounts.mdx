...
Destination accounts are accounts where payment funds are sent to. These
can either be liability accounts (student loans, mortgages, credit cards, etc.)
or bank accounts (checking or savings accounts). Since funds are being sent
to these accounts, they don't require any additional verification step.
