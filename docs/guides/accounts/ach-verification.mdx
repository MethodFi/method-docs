...
ACH Verification activates an account's `payments:send` capability,
allowing it to then be used to send payments (as a source).
...
- [__Micro-deposits__](#micro-deposits-verification) - two small amounts of money will be deposited into the ACH account,
...
After an ACH account has been created, you can start the verification process by
...
### Plaid verification
ACH accounts that have been created by retrieving routing
