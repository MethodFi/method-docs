...
Method uses HTTP status codes to indicate the success or failure of API requests. This includes -
...
### 4XX - Invalid request
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
...
`INVALID_TOKEN` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`EXPIRED_TOKEN` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`INVALID_ENTITY` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`INVALID_ACCOUNT_MASK` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`MISSING_MERCHANT_ID` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`UNSUPPORTED_AGGREGATOR` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`INVALID_AGGREGATOR_ENV` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`MISSING_BIN` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`INVALID_BIN_SIZE` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`MISSING_ROUTING_NUMBER` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`INVALID_ROUTING_NUMBER_SIZE` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
`INVALID_ROUTING_NUMBER` | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Something about 4XX errors here.
