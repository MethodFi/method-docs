...
An Entity can be created with an empty object and progressively updated with more information from your end user. See [Entity Capabilities](/docs/api/core/entities/object#entity-capabilities) for more info.

**API Method**: `POST /entities`

> 💡️ **Tip**: We recommend verifying the entity's phone number and email before initiating the verification process.
