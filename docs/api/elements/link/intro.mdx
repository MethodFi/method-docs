...
Your backend server will make a request to `/elements/token` to generate a `element_token` for an `entity`. This `element_token` will be used to initialize the Link Element in your app.

➡️ [Implementation Guide - Create Element Token](/api/elements/link/implementation/create-token)
...
➡️ [Implementation Guide - Launch Link Element](/api/elements/link/implementation/launch-link)
...
➡️ [Implementation Guide - Exchange Public Account](/api/elements/link/implementation/exchange-public-accounts)
