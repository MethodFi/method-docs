...
> **Tip**: Use the [merchants endpoint](/docs/api/core/merchants/list) to find the corresponding `mch_id` for the identifier used by your aggregator. (e.g Plaid's `ins_id`)
