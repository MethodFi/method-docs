...
➡️  See [Method Environments](/docs/api/environments) for more info.
...
➡️ [Intro to Link](/docs/api/elements/link/intro)

➡️ [Link Implementation Guide](/docs/api/elements/link/implementation/create-token)
