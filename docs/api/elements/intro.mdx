...
### Auth
The Auth Element allows your users to automatically connect all their debt accounts into Method by verifying
their identity.

➡️ [Intro to Auth](/api/elements/auth/intro)

➡️ [Auth Implementation Guide](/api/elements/auth/implementation/create-token)
