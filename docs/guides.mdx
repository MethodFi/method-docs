...
<CardContainer>
  ...
  />
  <Card
    icon="/img/sidebar-icon/guides/arrow-repeat.svg"
    href="/guides/quick-start/sync-a-liability"
    header="Sync a liability's data"
    body="Retrieve real-time balance, payoff and more for a liability."
  />
  <Card
    icon="/img/sidebar-icon/guides/entities.svg"
    href="/guides/entities"
  ...
  <Card
    ...
    body="Verify an entity's identity to retrieve their debts."
  />
  <Card
    icon="/img/sidebar-icon/guides/retrieve-liability-account-data.svg"
    href="/guides/accounts/retrieve-liability-account-data"
    header="Liability account data"
    body="Retrieve enhanced liability data for an account."
  />
</CardContainer>
