...
* **Entity capabilities**: An entity will have specific capabilities based on the data provided. ([docs](/api/core/entities/object#capabilities))
* **Receive Only entities**: This entity type is being deprecated. See docs for more info. ([docs](/api/core/entities/object#capabilities))
